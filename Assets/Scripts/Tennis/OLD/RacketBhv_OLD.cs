...
public class RacketBhv_OLD : CachedTransformBhv
{
    // Public properties
    ...
    private RacketColliderBhv_OLD _racketCollider;
    ...
    {
        _smoothingRateVelocity = smoothingTimeConstantVelocity.TauToLambda(Time.fixedDeltaTime);
        _smoothingRateNormal = smoothingTimeConstantNormal.TauToLambda(Time.fixedDeltaTime);
    ...
    protected override void Awake()
    {
        ...
        _racketCollider = GetComponentInChildren<RacketColliderBhv_OLD>();
    }

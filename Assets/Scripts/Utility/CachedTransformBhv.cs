...
{
    // Public properties
    public Transform Transform => _transform == null ? this.transform : _transform;
    ...
    public virtual Vector3 Position { get { return this.Transform.position; } set { this.Transform.position = value; } }
    public virtual Quaternion Rotation { get { return this.Transform.rotation; } set { this.Transform.rotation = value; } }
